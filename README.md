...
-----
## Código base
O código abaixo é o ponto de partida obrigatório. Ele realiza o teste de inicialização do LCD no `setup()`. Não remova nem altere o bloco de inicialização — adicione seu código apenas a partir dos comentários indicados.
```cpp
#include <Wire.h>
#include <LiquidCrystal_I2C.h>
// Configuracao do LCD I2C (endereco 0x27, 16 colunas, 2 linhas)
